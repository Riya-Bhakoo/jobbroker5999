...
<footer class="footer-emp-w3layouts bg-dark dotts py-lg-5 py-3">
    <div class="container-fluid px-lg-5 px-3">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="contact-info">
                            <h4>Location :</h4>
                            <p>Work Broker Wellington Institute of Technology & Whitireia New Zealand</p>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="contact-info">
                            <h4>Contact :</h4>
                            <p>Phone : +64274408676</p>
                            <p>Email :
                                <a href="mailto:tui.bradbrook@weltec.ac.nz">tui.bradbrook@weltec.ac.nz</a>
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="copyright mt-4">
            <p class="copy-right text-center ">&copy; 2020 Job Broker. All Rights Reserved | Design by
                <a href=""> Karan </a>
            </p>
        </div>
    </div>
