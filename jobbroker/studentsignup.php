            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="cs" class="form-control" data-rule-required="true">
                    </div>
                    <div class="form-group">
                        <label>Course Completed</label>
                        <input type="date" name="cc" class="form-control" data-rule-required="true">
                    </div>
                    <div class="form-group">
                ...
                <div class="col-sm-3">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" name="photo" class="form-control" data-rule-required="true" data-rule-extension="jpg|png|gif">
                    </div>
                    <div class="form-group">
